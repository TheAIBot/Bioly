...
namespace BiolyTests.Dilution
{
    ...
    public class TestDilution
    {
        ...
        public void testDMRW() {
            ...
            Assert.AreEqual(0, mixingSequence[4]); //isAssignedRight
            ...
            //2
            Assert.AreEqual(1, mixingSequence[8]); //isAssignedRight
            ...
            //3
            Assert.AreEqual(0, mixingSequence[12]); //isAssignedRight
            ...
            //4
            Assert.AreEqual(1, mixingSequence[16]); //isAssignedRight
            ...
            //5
            Assert.AreEqual(1, mixingSequence[20]); //isAssignedRight
            ...
            //6
            Assert.AreEqual(0, mixingSequence[24]); //isAssignedRight
            ...
            //7
            Assert.AreEqual(0, mixingSequence[28]); //isAssignedRight
            ...
            //8
            Assert.AreEqual(0, mixingSequence[32]); //isAssignedRight
            ...
            //9
            Assert.AreEqual(1, mixingSequence[36]); //isAssignedRight
            ...
            //10
            Assert.AreEqual(1, mixingSequence[40]); //isAssignedRight
            ...
            //11
            Assert.AreEqual(1, mixingSequence[44]); //isAssignedRight
