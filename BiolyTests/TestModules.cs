...
namespace BiolyTests.ModulesTests
{
    ...
    public class TestModules
    {
        ...
        public void TestFluidTransferFromDroplet()
        {
            ...
            Fluid fluidTransfer1 = new Fluid(new List<FluidInput>() { new FluidInput(inputOperation, numberOfDropletsTransfered, false) }, op1Name, null, "");
            //Testing (renaming) droplets:
            Fluid fluidTransfer2 = new Fluid(new List<FluidInput>() { new FluidInput(fluidTransfer1, numberOfDropletsRenamed, false) }, op2Name, null, "");
        ...
        public void TestFluidTransferFromInput()
        {
            ...
            Fluid fluidTransfer1 = new Fluid(new List<FluidInput>() { new FluidInput(inputOperation, numberOfDropletsTransfered, false) }, "op1", null, "");
            dfg.AddNode(inputOperation);
            dfg.AddNode(fluidTransfer1);
            dfg.FinishDFG();
            Assay assay = new Assay(dfg);
